...
const PostPage = () => {
    ...
    const onSubmit: SubmitHandler<FormData> = async (data) => {
        ...
        toast.success('Comment adding Successfully!', {
            id: notification
        })
    }
            ...
            <div className="rounded-md border border-gray-300 bg-white p-5 pl-16">
                ...
                >
                    <textarea
                        {...register('comment')}
                        disabled={!session}
                        className="h-24 rounded-md border border-gray-200 p-2 pl-4 outline-none disabled:bg-gray-50 w-full"
                        placeholder={session ? 'What are you thoughts?' : 'Please, Sign In for comment..'}
                    />
